...
| Reviewed editorial examples and historical renderers | `tools/build_company_editorial.py`, `tools/build_company_briefs.py`, `output/five-company-review/render_email.py` and its template | Apply this guide to future prose edits. Preserve archived evidence, sent artifacts and reviews; changed candidates need fresh review. |
